...
import com.tohsoft.app.ui.helpers.Events
import com.tohsoft.app.ui.helpers.config
//import com.tohsoft.app.ui.helpers.updateWidgets
...
class MyCameraImpl(val context: Context) {
    ...
    fun isSOSRunning(): Boolean {
        return isSOSRunning;
    }

    fun isStroboscopeRunning(): Boolean {
